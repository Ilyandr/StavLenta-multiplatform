...
import gcu.production.stavlenta.android.domain.viewModels.auth.RegistrationViewModel
...
internal fun RegistrationScreen(
    ...
    when (val value = state.value) {
        ...
        is AuthModel.SuccessState -> {
            ...
            rootController.push(HOME_DESTINATION, launchFlag = LaunchFlag.SingleNewTask)
        }
    ...
    AppBarLayout(enableBackButton = true, transparentBar = true) {
        Box(
            modifier = Modifier.fillMaxSize().scrollable(state = scrollState, orientation = Orientation.Vertical),
            ...
            Card(
                ...
                Column(
                    ...
                    HeaderTextView(R.string.registration_title)
                }
                ...
                Column(
                    ...
                    BaseButton(loadingState.value, R.string.dialog_next) {
                        viewModel registrationAction UserModel(
                            name = nameText,
                            email = loginText,
